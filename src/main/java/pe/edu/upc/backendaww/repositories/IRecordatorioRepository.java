...
public interface IRecordatorioRepository extends JpaRepository<Recordatorio,Integer> {
    ...
    @Query("from Recordatorio rt where rt.estadoRecordatorio like %:estadoRecordatorio%")
    List<Recordatorio> buscarRecordatorio(@Param("estadoRecordatorio")String estadoRecordatorio);
}